              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {tableHoursData.map((dataObject, idx) => (
                  <tr
                    ...
                    className={`${dataObject.special_day ? 'bg-blue-300 hover:bg-blue-400 ' : dataObject.holiday ? 'bg-green-300 hover:bg-green-500 ' : 'even:bg-gray-50 hover:bg-gray-100'}  transition-colors`}
                  >
